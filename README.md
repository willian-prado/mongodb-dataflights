...
Primeiro projeto sobre MongoDB, aqui aplicamos nossos conhecimentos sobre métodos mais básicos, como find(), insertOne(), insertMany(), deleteOne(), deleteMany() e operadores de comparação e lógicos (usados em conjunto do find()).
